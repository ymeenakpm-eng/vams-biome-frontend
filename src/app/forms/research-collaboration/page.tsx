...
export default function ResearchCollaborationFormPage() {
  return (
    <main className="min-h-screen bg-slate-50 py-16">
      <div className="mx-auto max-w-3xl px-6">
        <header className="mb-10 text-center">
          <p className="text-base font-semibold uppercase tracking-wide text-cyan-700">Forms</p>
          <h1 className="mt-3 text-4xl font-bold text-slate-900 md:text-5xl">Research collaboration</h1>
          <p className="mt-4 text-base text-slate-600 text-justify">
            Placeholder form for research collaboration requests.
          </p>
        </header>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          <form className="space-y-5 text-base">
            ...
            <div>
              <label className="block text-base font-medium text-slate-700" htmlFor="message">Proposal summary</label>
