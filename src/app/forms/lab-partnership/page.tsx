...
export default function LabPartnershipFormPage() {
  return (
    <main className="min-h-screen bg-slate-50 py-16">
      <div className="mx-auto max-w-3xl px-6">
        <header className="mb-10 text-center">
          <p className="text-base font-semibold uppercase tracking-wide text-cyan-700">Forms</p>
          <h1 className="mt-3 text-4xl font-bold text-slate-900 md:text-5xl">Lab partnership / quote request</h1>
          <p className="mt-4 text-base text-slate-600 text-justify">
            Placeholder form for lab partnerships, pricing, and white-label reporting.
          </p>
        </header>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          <form className="space-y-5 text-base">
            ...
            <div>
              <label className="block text-base font-medium text-slate-700" htmlFor="org">Lab / organization</label>
              <input id="org" className="mt-1 w-full rounded-lg border border-slate-200 px-4 py-3 text-base" />
            </div>
            <div>
              <label className="block text-base font-medium text-slate-700" htmlFor="message">Partnership needs</label>
