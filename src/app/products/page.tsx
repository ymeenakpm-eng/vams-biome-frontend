      ...
      <div className="mx-auto px-20">
        <header className="mb-12 flex min-h-[calc(100vh-120px)] flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="flex-1">
            ...
            <p className="mt-4 max-w-2xl text-xl text-slate-600 text-justify">
          ...
          <div className="flex flex-1 flex-col items-start gap-4 md:items-end">
            <div className="relative hidden h-56 w-full overflow-hidden rounded-2xl bg-emerald-900/80 md:block lg:h-72">
              <Image
                src="/images/lab-hero.jpg"
                alt="VAMS BIOME probiotics and lab environment"
                fill
            ...
            <Link
              href="/diagnostics"
              className="rounded-full border border-emerald-200 px-6 py-3 text-lg font-semibold text-emerald-800 hover:bg-emerald-50"
            >
        ...
        <section className="mb-12 text-lg">
          <h2 className="mb-5 text-3xl font-semibold text-slate-900">Shop by category</h2>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <article
                key={label}
                className="flex flex-col justify-between overflow-hidden rounded-2xl bg-white shadow-sm"
              >
                <div className="relative h-28 w-full overflow-hidden bg-emerald-900/80">
                  <Image
                    src="/images/lab-hero.jpg"
                    alt={`${label} visual`}
                    fill
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  <div>
                    <h3 className="text-3xl font-semibold text-slate-900">{label}</h3>
                  ...
                  <a
                    ...
                    className="mt-5 inline-flex w-fit rounded-full bg-emerald-500 px-5 py-2 text-sm font-semibold text-white hover:bg-emerald-600"
                  >
                    View products
                  </a>
                </div>
        ...
        <section
          ...
          className="mb-12 scroll-mt-28 rounded-2xl bg-white p-8 shadow-sm"
        >
        ...
        {/* Subscription boxes */}
        <section className="mb-12 grid gap-8 md:grid-cols-2 text-lg">
          <div className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-3xl font-semibold text-slate-900">Subscription boxes</h2>
            ...
            <button className="mt-5 inline-flex rounded-full bg-emerald-500 px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-emerald-600">
              Subscribe &amp; Save
            </button>
          </div>
          <div className="rounded-2xl bg-emerald-900 p-8 text-emerald-50">
            <h3 className="mb-3 text-base font-semibold uppercase tracking-wide text-emerald-200">
        ...
        <section className="mb-12 rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="mb-4 text-3xl font-semibold text-slate-900">What you will see on each product page</h2>
          <p className="mb-4 text-base text-slate-600">
        ...
        <section className="mb-12 rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="mb-3 text-3xl font-semibold text-slate-900">Featured therapeutic example</h2>
          ...
          <Link
            ...
            className="mt-4 inline-flex text-lg font-semibold text-emerald-700 hover:text-emerald-800"
          >
        ...
        <section className="mb-12 rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="mb-4 text-3xl font-semibold text-slate-900">Human Probiotics Formulations</h2>
          ...
          <div className="mb-5 text-sm text-slate-700">
            <h3 className="text-base font-semibold text-slate-900">Key features (SEO-optimised)</h3>
          ...
          <div className="grid gap-5 md:grid-cols-2 text-base text-slate-700">
        ...
        <section className="mb-12 rounded-2xl bg-white p-8 shadow-sm">
          <h2 className="mb-4 text-3xl font-semibold text-slate-900">Aquaculture Solutions</h2>
          <p className="mb-4 text-base text-slate-600 text-justify">
          ...
          <div className="mb-4 text-sm text-slate-700">
            <h3 className="text-base font-semibold text-slate-900">Heat-stable probiotic formulations</h3>
          ...
          <div className="mt-4 text-sm text-slate-700">
            <h3 className="text-base font-semibold text-slate-900">Key benefits</h3>
            <ul className="mt-1 list-disc space-y-1.5 pl-5">
        ...
        <section className="rounded-2xl bg-slate-900 p-8 text-slate-50">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-3xl font-semibold">Vendor & partner portal</h2>
            ...
            <Link
              href="/contact"
              className="rounded-full bg-emerald-500 px-6 py-3 text-lg font-semibold text-white shadow-sm hover:bg-emerald-600"
            >
              Talk to our team
            </Link>
          </div>
