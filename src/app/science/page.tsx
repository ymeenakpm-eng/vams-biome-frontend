    ...
    <main className="min-h-screen bg-slate-50 py-16">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <section className="mb-12">
          <h2 className="mb-5 text-3xl font-semibold text-slate-900 text-center">
            Education pillars
          </h2>
          <div className="grid gap-6 md:grid-cols-2 text-base">
            <article className="rounded-2xl bg-white p-8 shadow-sm">
              <h3 className="mb-2 text-2xl font-semibold text-slate-900">Microbiome 101</h3>
            ...
            <article className="rounded-2xl bg-white p-8 shadow-sm">
              <h3 className="mb-2 text-2xl font-semibold text-slate-900">Women&apos;s health</h3>
              <p className="text-base text-slate-600 text-justify">
            ...
            <article className="rounded-2xl bg-white p-8 shadow-sm">
              <h3 className="mb-2 text-2xl font-semibold text-slate-900">Gut–brain–skin axis</h3>
              <p className="text-base text-slate-600 text-justify">
            ...
            <article className="rounded-2xl bg-white p-8 shadow-sm">
              <h3 className="mb-2 text-2xl font-semibold text-slate-900">Personalised nutrition</h3>
              <p className="text-base text-slate-600 text-justify">
            ...
            <article className="rounded-2xl bg-white p-8 shadow-sm md:col-span-2">
              <h3 className="mb-2 text-2xl font-semibold text-slate-900">AI in wellness</h3>
              <p className="text-base text-slate-600 text-justify">
        ...
        <section className="mb-12 grid gap-6 md:grid-cols-2 text-base">
          <article className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-3 text-2xl font-semibold text-slate-900">Microbiome 101</h2>
            <p className="text-base text-slate-600 text-justify">
          ...
          <article className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-3 text-2xl font-semibold text-slate-900">Metabolites &amp; SCFAs</h2>
            <p className="text-base text-slate-600 text-justify">
        ...
        <section className="mb-12 grid gap-6 md:grid-cols-2 text-base">
          <article className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-3 text-2xl font-semibold text-slate-900">Lab &amp; technology</h2>
            <p className="text-base text-slate-600 text-justify">
          ...
          <article className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-3 text-2xl font-semibold text-slate-900">Validation &amp; quality</h2>
            <p className="text-base text-slate-600 text-justify">
        ...
        <section className="mb-12 rounded-2xl bg-emerald-900 p-8 text-emerald-50">
          <h2 className="mb-3 text-2xl font-semibold">Whitepapers &amp; publications</h2>
        ...
        {/* Lead magnets + FAQ */}
        <section className="mt-12 grid gap-6 md:grid-cols-2 text-base">
          <article className="rounded-2xl bg-sky-100 p-8">
            <h2 className="text-2xl font-semibold text-slate-900">Free guides &amp; checklists</h2>
          ...
          <article className="rounded-2xl bg-white p-8 shadow-sm">
            <h2 className="mb-3 text-2xl font-semibold text-slate-900">Common questions</h2>
            <dl className="space-y-4 text-base text-slate-700">
              <div>
